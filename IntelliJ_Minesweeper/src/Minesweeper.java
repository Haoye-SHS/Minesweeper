    ...
    public static void refresh() {
        ...
        for (int x = 0; x < minefield.length; x++) {
            ...
            for (int y = 0; y < minefield[x].length; y++) {
                ...
                if (minefield[x][y][0] == 1 && minefield[x][y][1] == 1 && minefield[x][y][2] == 0) System.out.print("X ");
                if (minefield[x][y][0] == 1 && minefield[x][y][2] == 0 && checkAdjMines(x, y) == 0) System.out.print("  ");
